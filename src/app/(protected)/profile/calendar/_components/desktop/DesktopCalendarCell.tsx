...
import EmotionPlanetImage from '../../../../../_components/ui/emotion/EmotionPlanetImage';
...
export default function DesktopCalendarCell({ day, isToday, emotionId, onClick }: DesktopCalendarCellProps) {
  ...
  return (
    <div
      ...
      className={cn(
        'relative h-full w-full cursor-pointer p-4 outline outline-[0.5px] outline-[var(--gray-3)] hover:!bg-[var(--gray-a3)]'
      )}
    >
      {/* Day number */}
