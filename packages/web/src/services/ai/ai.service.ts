...
export const aiService = {
   ...
   */
  getPeriodAnalysis: async (
    params: GetPeriodAnalysisParams
  ...
  predictEmotion: async (
    params: EmotionPredictionRequest
  ): Promise<ApiResponse<EmotionPredictionResponse>> => {
   ...
   */
  getDiarySummary: async (
    params: GetDiarySummaryParams
  ): Promise<ApiResponse<DiarySummaryResponse>> => {
