    ...
    <Flex direction="column" gap="5">
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          By accessing and using ZeroGravity (&quot;Service&quot;), you accept and agree to be bound by these
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          ZeroGravity is an emotion tracking and personal wellness application that helps users
          monitor their emotional states, visualize patterns, and receive personalized insights.
          The Service includes web and browser extension platforms.
        </Text>
      </Flex>
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          You may create an account using supported OAuth providers (Google, Kakao). You are
          responsible for maintaining the confidentiality of your account and for all activities
          that occur under your account. You agree to immediately notify us of any unauthorized
          use of your account.
        </Text>
      </Flex>
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          Your use of the Service is also governed by our Privacy Policy and Sensitive Personal
          Data Agreement. We collect, process, and store your emotion data, personal notes, and
          related information as described in those documents.
        </Text>
      </Flex>
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          The Service and its original content, features, and functionality are owned by ZeroGravity
          and are protected by international copyright, trademark, and other intellectual property
          laws. You retain ownership of the content you create through the Service.
        </Text>
      </Flex>
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          ...
          SECURE, OR ERROR-FREE. THE SERVICE IS NOT A SUBSTITUTE FOR PROFESSIONAL MEDICAL OR
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          TO THE MAXIMUM EXTENT PERMITTED BY LAW, ZEROGRAVITY SHALL NOT BE LIABLE FOR ANY INDIRECT,
          INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR
          REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, OR OTHER
          INTANGIBLE LOSSES.
        </Text>
      </Flex>
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          ...
          prior notice or liability, for any reason, including breach of these Terms. You may
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          ...
          jurisdiction in which ZeroGravity operates, without regard to its conflict of law
          provisions.
        </Text>
      </Flex>
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          If you have any questions about these Terms, please contact us through the Service or at
