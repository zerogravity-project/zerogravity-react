    ...
    <Flex direction="column" gap="5">
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          ...
          Your data is stored on secure servers with encryption both in transit and at rest.
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          ...
          to provide you with the Service. If you delete your account, we will permanently delete
          your personal information within 30 days, except where we are required to retain it by
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }} ml="4">
          We use Google and Kakao OAuth for authentication. When you sign in, these providers
          share basic profile information (name, email, profile picture) with us. Your use of
        ...
        <Text size="3" style={{ lineHeight: '1.6' }} ml="4">
          If you consent to AI-powered analysis, your emotion data may be sent to Google Gemini
          AI for processing. Please refer to our AI-Powered Analysis Agreement for more details.
        </Text>
      </Flex>
      ...
      <Flex direction="column" gap="3">
        ...
        <Flex direction="column" gap="2" ml="4">
          ...
          <Text size="3">• With service providers who assist in operating the Service (under strict confidentiality agreements)</Text>
        </Flex>
      </Flex>
      ...
      <Flex direction="column" gap="3">
        ...
        <Flex direction="column" gap="2" ml="4">
          <Text size="3">• <strong>Access:</strong> Request a copy of your personal data</Text>
          <Text size="3">• <strong>Correction:</strong> Update or correct inaccurate information</Text>
          <Text size="3">• <strong>Deletion:</strong> Request deletion of your account and data</Text>
          <Text size="3">• <strong>Portability:</strong> Request your data in a machine-readable format</Text>
          <Text size="3">• <strong>Consent Withdrawal:</strong> Withdraw consent for optional data processing</Text>
        </Flex>
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          ...
          your preferences, and analyze Service usage. Essential cookies are required for the
          Service to function properly. You can control cookie settings through your browser,
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          ...
          of residence. We ensure that appropriate safeguards are in place to protect your
      ...
      <Flex direction="column" gap="3">
        ...
        <Text size="3" style={{ lineHeight: '1.6' }}>
          ...
          contact us through the Service or at our official support channels.
        </Text>
      </Flex>
    </Flex>
  );
